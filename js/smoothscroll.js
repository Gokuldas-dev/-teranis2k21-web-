...
function fixedMenu() {
  ...
  if (scrollY >= 50) {
    ...
    $(".head-temp").css("position", "");
    $(".head-temp").css("background", "");
    $(".nav .navbar-dark a.nav-link.active").css("color", "");
    $(".head-temp").css("height", "");
    $(".head-temp").css("padding-bottom", "");
    $(".head-menu .nav.navbar").css("background", "");
    $(".head-logo").css("width", "");
    $(".head-menu .nav").css("top", "");
    $("head-menu .nav .navbar-nav .nav-item").css("color", "");
    $(".head-logo .logo img").css("max-height", "");
    $(".nav .navbar-collapse").css("background-color", "");
    $(".nav .navbar-dark a.nav-link").css("color", "");
    $(".nav .navbar-dark a.nav-link.active").css("color", "");
    $(".head-logo .logo img").attr("src", "img/logo.png");
    $(".head-temp .head-cont").show();
  }
}
